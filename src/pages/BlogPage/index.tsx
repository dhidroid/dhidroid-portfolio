...
/**
 * Create a Sanity image URL builder for the provided image source.
 *
 * @param source - A Sanity image source (an image document, an asset reference, or similar value accepted by the Sanity image builder)
 * @returns A Sanity Image URL builder instance configured for `source`, supporting chaining (e.g., `.width(...).fit(...).url()`).
 */
